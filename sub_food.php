...
?>
<link rel="stylesheet" href="./css/pagination_food.css">

<main>
    <section class="map_banner">
        <img src="./img/food_main_img.png" alt="map_banner" class="map_banner">
        <div class="map_title">
            <img src="./img/food_marker.png" alt="marker" style="object-fit: cover">
    ...
    <script src="./js/dataPlus.js"></script>
    <script src="./js/map_foods.js"></script>
