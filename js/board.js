...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const targetAddress = "board.php";

  if (window.location.href.includes(targetAddress) && params["bcode"]) {
    // 글쓰기 버튼
    const btn_write = document.querySelector("#btn_write");

    btn_write.addEventListener("click", () => {
      window.location.href = "./board_write.php?bcode=" + params["bcode"];
    });
