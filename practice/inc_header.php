    ...
    <div class="container">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a href="mypage.php" class="nav-link">My Page</a></li>
                <?php } ?>
                <li class="nav-item"><a href="board.php" class="nav-link">게시판</a></li>
                <li class="nav-item"><a href="./pg/logout.php" class="nav-link">로그아웃</a></li>
                <?php
                } else {
                    // 로그인 안된 상태
                ?>
